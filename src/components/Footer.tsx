  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className={`grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-12 items-start ${isRtl ? "text-right" : "text-left"}`}>
          {/* ========================================================= */}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-1">
                <h4 className="font-lalezar text-2xl sm:text-3xl text-teal-400 font-normal leading-tight">
                  {t.ui.footer.brandTitle}
                </h4>
                <p className="text-xs text-slate-400 font-light">
                  {t.ui.footer.brandSubtitle}
                </p>
              </div>
            </div>
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <div className="flex flex-col gap-2.5 pt-1">
              ...
              >
                ...
                <span>{t.ui.footer.instagramLabel}</span>
              </a>
              ...
              >
                ...
                <span>{t.ui.footer.telegramLabel}</span>
              </a>
              ...
              >
                ...
                <span>{t.ui.footer.whatsappLabel}</span>
              </a>
            </div>
          </div>
          ...
          <div className="md:col-span-5 space-y-3 p-6 rounded-3xl bg-slate-900/60 border border-white/10 shadow-inner">
            <h4 className="font-lalezar text-xl text-white font-normal">
              {t.ui.footer.newsletterTitle}
            </h4>
            <p className="text-xs text-slate-300/80 font-light leading-relaxed">
              {t.ui.footer.newsletterDesc}
            </p>
            <div className="pt-2 w-full">
              <NewsLetterForm buttonText={t.ui.footer.newsletterButton} />
            </div>
          </div>
        </div>
