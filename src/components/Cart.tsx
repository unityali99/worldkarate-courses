...
export function CartDrawer() {
  ...
  const { courses, remove, clear, isOpen, setIsOpen } = useCart();
...
export default function Cart({ showDrawer = true }: { showDrawer?: boolean }) {
  const { courses, hydrated, setHydrated, setIsOpen } = useCart();
